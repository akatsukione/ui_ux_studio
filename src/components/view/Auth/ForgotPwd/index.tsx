...
export const ForgotPwdView: React.FC = () => {
  const onForgotPwdAction = (): void => {
        ...
        <div className="flex flex-col mr-26 justify-center items-center">
          ...
          <div className="flex flex-col items-center rounded-3xl shadow shadow-white/15">
            ...
            <div className="relative m-6">
              <button
                onClick={onForgotPwdAction}
                className="w-96 h-14 bg-575DFB rounded-[30px] text-white font-poppins text-16 not-italic font-medium tracking-[-0.176px] leading-7"
              >
                Continue
              </button>
            </div>
